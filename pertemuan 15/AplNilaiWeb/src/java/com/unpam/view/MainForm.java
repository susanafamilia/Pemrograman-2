...
public class MainForm extends HttpServlet {
    ...
    // URUTAN PARAMETER DISESUAIKAN: request, response, baru konten
    public void tampilkan(HttpServletRequest request, 
        ...
        String menu = "<br><b>Master Data</b><br>"
                        + "<a href='MahasiswaController'>Mahasiswa</a><br>"  // Mengarah ke MahasiswaController
                        + "<a href='MataKuliahController'>Mata Kuliah</a><br><br>" // Mengarah ke MataKuliahController
                        + "<b>Transaksi</b><br>"
                        + "<a href='NilaiController'>Nilai</a><br><br>" // Mengarah ke NilaiController
                        + "<b>Laporan</b><br>"
        ...
        String topMenu = "<nav><ul>"
                        ...
                        + "<ul>"
                        + "<li><a href='MahasiswaController'>Mahasiswa</a></li>" // Mengarah ke MahasiswaController
                        + "<li><a href='MataKuliahController'>Mata Kuliah</a></li>" // Mengarah ke MataKuliahController
                        + "</ul>"
                        + "</li>"
                        + "<li><a href=#>Transaksi</a>"
                        + "<ul>"
                        + "<li><a href='NilaiController'>Nilai</a></li>" // Mengarah ke NilaiController
                        + "</ul>"
                        + "</li>"
                        + "<li><a href=#>Laporan</a>"
                        + "<ul>"
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        // Karena MainForm digunakan sebagai view penampung, jika diakses langsung
        // kita tampilkan halaman kosong awal yang nanti memicu teks 'Selamat Datang'
